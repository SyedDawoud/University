...
public class Rogue{
    ...
    public void showNotInScheme(){
        results=access.getNotInCurrentScheme("Rogue CHC");
    ...
    public void sdRound(){
        standard_deviation_rounds=access.SDRound("Rogue CHC");
    }
    
    
    public void sdChallenge(){
        standard_deviation_per_challenge=access.SDRoundCorrectness("Rogue CHC");
    }
    
    
    public void meanError(){
        overAllError=access.OverAllError("Rogue CHC");
        
    }
    
    
    public void meanCorrectLoginTime(){
        mean_correct_login_time=access.meanTaskG("Rogue CHC");
    }
    
    public void CorrectPass(){
        correctPasswords=access.correctPasswordInput("Rogue CHC");
    }
    ...
    public void MeanPerChallenge(){
       ...
       mean_percentage_challenge=access.meanOfChallenge("Rogue CHC");
    }
    
    public void MeanPerRound(){
        mean_per_round=access.meanOfRound("Rogue CHC");
    }
