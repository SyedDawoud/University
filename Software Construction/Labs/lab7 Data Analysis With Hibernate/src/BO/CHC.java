...
public class CHC {
    ...
    public void showNotInScheme(){
        results=access.getNotInCurrentScheme("CHC");
    ...
    public void sdRound(){
        standard_deviation_rounds=access.SDRound("CHC");
    }
    
    
    public void sdChallenge(){
        standard_deviation_per_challenge=access.SDRoundCorrectness("CHC");
    }
    
    
    public void meanError(){
        overAllError=access.OverAllError("CHC");
        
    }
    
    
    public void meanCorrectLoginTime(){
        mean_correct_login_time=access.meanTaskG("CHC");
    }
    
    public void CorrectPass(){
        correctPasswords=access.correctPasswordInput("CHC");
    }
    ...
    public void MeanPerChallenge(){
       ...
       mean_percentage_challenge=access.meanOfChallenge("CHC");
    }
    
    public void MeanPerRound(){
        mean_per_round=access.meanOfRound("CHC");
    }
