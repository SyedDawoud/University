...
public class ReservationSystemTest {
    ...
    /**
     * Test of LTableAvailability method, of class ReservationSystem.
     */
    @Test
    public void testLTableAvailability() {
        System.out.println("LTableAvailability");
        boolean expResult = true;
        boolean result = instance.LTableAvailability();
        assertEquals(expResult, result);
    }

    /**
     * Test of MTableAvailability method, of class ReservationSystem.
     */
    @Test
    public void testMTableAvailability() {
        System.out.println("MTableAvailability");
        boolean expResult = true;
        boolean result = instance.MTableAvailability();
        assertEquals(expResult, result);
    }

    /**
     * Test of STableAvailability method, of class ReservationSystem.
     */
    @Test
    public void testSTableAvailability() {
        System.out.println("STableAvailability");
       boolean expResult = true;
        boolean result = instance.STableAvailability();
        assertEquals(expResult, result);
    }
