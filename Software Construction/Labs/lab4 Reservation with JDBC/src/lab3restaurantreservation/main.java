...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFrame6.setMinimumSize(new java.awt.Dimension(600, 500));
...
//            }
//            else{
//                Table temp=new Table(tab,0);
//                time=temp.getSlot(Rc.getSlot());
//            }
//            
//            jTextField5.setText(jTextField5.getText().toString()+"\r\nName:"+ Rc.getName() + "; Time:" + time + "; People:"+Rc.getPersonReserved() + "; Table :"+Rc.getTable());
//           time="";
//        }
...
//        jFrame1.setVisible(false);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            ...
            int size=db.dataSize("select * from users where username=? and password=? and userType=?", user, pass, "Staff");
...
// This will populate the List that would be shown on the GUI   
